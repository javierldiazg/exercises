...
import ExerciseThree from "@/app/exercise3/page";
...
jest.mock("../../components/RangeFull/RangeFull", () => ({
  __esModule: true,
  RangeFull: ({ min, max }: { min: number; max: number }) => (
...
describe("ExerciseThree Page", () => {
  ...
  it("displays loading state initially", () => {
    ...
    render(<ExerciseThree />);

    expect(screen.getByText("Loading...")).toBeInTheDocument();
  });

  it("renders the RangeFull component with data after loading", async () => {
